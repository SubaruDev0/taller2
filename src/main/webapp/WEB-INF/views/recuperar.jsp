...
<head>
    ...
    <title>Clínica Dental | Recuperar Contraseña</title>
...
<div class="contenedor-login oculto">
    <div class="tarjeta-login">
        <div class="encabezado-login">
            ...
            <p class="subtitulo">Ingresa tu usuario y contraseña actual para cambiarla</p>
        </div>
        <form class="formulario-login" method="POST" action="${pageContext.request.contextPath}/recuperar">
            ...
            <div class="grupo-entrada">
                ...
                <label for="contrasenaActual"><i class="fas fa-lock"></i> Contraseña Actual</label>
            </div>
            <div class="grupo-entrada">
                <input type="password" id="nuevaContrasena" name="nuevaContrasena" required>
                <label for="nuevaContrasena"><i class="fas fa-key"></i> Nueva Contraseña</label>
            </div>
            <div class="grupo-entrada">
                <input type="password" id="confirmarContrasena" name="confirmarContrasena" required>
                <label for="confirmarContrasena"><i class="fas fa-key"></i> Confirmar Nueva Contraseña</label>
            </div>
            ...
            <button type="submit" class="boton-acceso">Cambiar Contraseña</button>
            <div style="margin-top:25px;text-align:center;font-size:1rem;">
                <a href="${pageContext.request.contextPath}/login" style="color:var(--azul-principal);font-weight:bold;text-decoration:none;">← Volver al inicio de sesión</a>
            </div>
        </form>
    </div>
</div>
