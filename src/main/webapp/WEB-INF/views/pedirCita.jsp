...
<%
    ...
    // Lista de servicios (se pasará desde el servlet)
                        ...
                        <style>
                            ...
                            * {
                            ...
                            .form-group textarea:focus {
                                ...
                                box-shadow: 0 0 0 3px rgba(15, 164, 156, 0.1)
                            }
                    ...
                    <body>
                        <header>
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <% if (session.getAttribute("rol") !=null && "ADMIN"
                                        .equals(session.getAttribute("rol"))) { %>
                        ...
                        <main class="container">
                            ...
                            <% if (mensajeExito !=null) { %>
                                <div
                                    style="background:#d4edda;color:#155724;padding:15px;border-radius:10px;margin-bottom:20px;text-align:center;font-weight:bold;">
                                    ✓ <%= mensajeExito %>
                                </div>
                                <% } %>
                                    <% if (mensajeError !=null) { %>
                                        <div
                                            style="background:#f8d7da;color:#721c24;padding:15px;border-radius:10px;margin-bottom:20px;text-align:center;font-weight:bold;">
                                            ✗ <%= mensajeError %>
                                        </div>
                                        <% } %>
                                            ...
                                            <% if (esInvitado || !estaLogueado) { %>
                                                <section class="form-section"
                                                    ...
                                                    <div style="max-width:600px;margin:0 auto;">
                                                        <i class="fas fa-lock"
                                                            style="font-size:4rem;color:var(--azul-principal);margin-bottom:20px;"></i>
                                                        <h2
                                                            style="color:var(--azul-principal);margin-bottom:15px;font-size:2rem;">
                                                            Acceso Restringido</h2>
                                                        <p
                                                            style="font-size:1.1rem;color:#666;margin-bottom:30px;line-height:1.6;">
                                                            Para solicitar una cita debes iniciar sesión con una cuenta
                                                            registrada.
                                                            <% if (esInvitado) { %>
                                                                <br><br>Estás navegando como <strong>invitado</strong>.
                                                ...
                                                <% } else { %>
                                                    <section id="citas" class="form-section">
                                                        <div class="formulario">
                                                            <form class="turno-form" id="formCita" method="POST"
                                                                action="${pageContext.request.contextPath}/pedirCita">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email" id="email" name="email"
                                                                        placeholder="su.email@ejemplo.com" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="servicio" name="servicio" required>
                                                                        ...
                                                                        <% if (servicios !=null && !servicios.isEmpty())
                                                                            ...
                                                                            <% } } else { %>
                                                                                ...
                                                                                <option value="2">Implantes Dentales
                                                                                </option>
                                                                                <option value="3">Endodoncia</option>
                                                                                <option value="4">Periodoncia</option>
                                                                                <option value="5">Blanqueamiento Dental
                                                                                </option>
                                                                                <option value="6">Odontología General
                                                                                </option>
                                                                                <% } %>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="horario" name="horario" required>
                                                                        <option value="" disabled selected>Seleccione un
                                                                            horario</option>
                                                                        <option value="mañana">Mañana (9:00 - 12:00)
                                                                        </option>
                                                                        <option value="tarde">Tarde (15:00 - 19:00)
                                                                        </option>
                                                                        <option value="sabado">Sábado (9:00 - 13:00)
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group full-width">
                                                                    ...
                                                                    <textarea id="mensaje" name="mensaje"
                                                                        placeholder="Describa brevemente el motivo de su consulta o alguna información relevante..."
                                                                        rows="4"></textarea>
                                                                </div>
                                                                <div class="form-group full-width">
                                                                    <label class="checkbox-label">
                                                                        ...
                                                                        Acepto los&nbsp;
                                                                        <a href="#" class="link">términos y
                                                                            condiciones</a>&nbsp;y la&nbsp;
                                                                        <a href="#" class="link">política de
                                                                            privacidad</a> *
                                                                    </label>
                                                                </div>
                                                                <button type="submit" class="btn-submit">Solicitar
                                                                    Cita</button>
                                                            </form>
                                                        </div>
                                                    </section>
                                                        ...
                                                        <section class="info-section">
                                                            <div class="info-grid">
                                                                <div class="info-card">
                                                                    ...
                                                                    <p><strong>Email:</strong> citas@clinicadental.cl
                                                                    </p>
                                                                </div>
                                                                <div class="info-card">
                                                                    <h3>🕒 Horarios de Atención</h3>
                                                                    <p><strong>Lunes a Viernes:</strong> 9:00 - 20:00
                                                                        hrs</p>
                        ...
                        <!-- Hidden field for preselected service ID -->
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", function () {
                                ...
                                // Pre-seleccionar servicio si viene desde una tarjeta
