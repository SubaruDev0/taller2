<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Cascadia+Code+PL:wght@400;700&display=swap"
            rel="stylesheet">
        ...
        <style>
            ...
            .contenedor-logo.ocultar-final {
                display: none !important;
            }

            .pantalla-inicial.ocultar-fondo-blanco {
            ...
            .contenedor-logo.mostrar-logo {
                animation: rotar-logo 0.7s ease-out forwards;
            }

            .contenedor-logo.desvanecer {
                animation: rotar-y-desvanecer 0.6s ease-in forwards;
            }
            ...
            .contenedor-login.visible {
                opacity: 1;
                animation: aparecer-horizontal 0.8s cubic-bezier(0.65, 0.05, 0.36, 1) forwards;
            }
            ...
            .grupo-entrada input:valid+label {
                top: -25px;
                left: 0;
                color: var(--azul-principal);
                font-size: 0.9rem;
            ...
            .grupo-entrada input:focus+label i,
            .grupo-entrada input:valid+label i {
                color: var(--azul-principal);
            }
            ...
            .cbx:after {
                ...
                border-right: 2px solid var(--fondo-tarjeta);
            ...
            #cbx-recordar:checked~.cbx {
                border-color: transparent;
                background: var(--azul-principal);
                animation: jelly 0.6s ease;
            }

            #cbx-recordar:checked~.cbx:after {
                opacity: 1;
            ...
            /* Animaciones */
            @keyframes expandir-horizontalmente {
                to {
                    transform: scaleX(1);
                }
            }
    ...
    <body>
        ...
        <div class="pantalla-inicial">
            ...
            <div class="contenedor-logo">
                <img src="${pageContext.request.contextPath}/img/logo.png" alt="Logo Clínica Dental"
                    class="logo-clinica">
            </div>
        </div>
        ...
        <div class="contenedor-login oculto">
            <div class="tarjeta-login">
                ...
                <form class="formulario-login" id="loginForm" method="POST"
                    ...
                    <div class="opciones-login">
                        ...
                        <a href="${pageContext.request.contextPath}/recuperar" class="olvide-contrasena">¿Olvidaste la
                            contraseña?</a>
                    </div>
                    ...
                    <div id="mensajeExito" class="<%= request.getAttribute(" exito")==null ? "oculto" : "" %>"
                        style="color:#155724;font-size:0.9rem;font-weight:bold;margin-bottom:20px;padding:10px;border:1px
                        solid #c3e6cb;background-color:#d4edda;border-radius:5px;text-align:center;">
                    ...
                    <div style="margin-top:25px;text-align:center;font-size:1rem;">
                        ...
                        <a href="${pageContext.request.contextPath}/registro"
                            style="color:var(--azul-principal);font-weight:bold;text-decoration:none;margin-left:5px;">Regístrate
                            aquí</a>
                    </div>
                </form>
            </div>
