                ...
                <section class="banner">
                    ...
                    <div class="banner-text">
                        ...
                        <button class="btn-banner"
                            onclick="window.location.href='${pageContext.request.contextPath}/pedirCita'">
                            Solicitar Cita
                        </button>
                    </div>
                </section>
...
===================== -->
                <section id="servicios">
                    ...
                    <div class="carousel-wrapper">
                        ...
                        <div class="carousel">
                            <% java.util.List<com.taller2.model.Servicio> servicios = (java.util.List
                                <com.taller2.model.Servicio>) request.getAttribute("servicios");
                                    if (servicios != null && !servicios.isEmpty()) {
                                    for (com.taller2.model.Servicio s : servicios) {
                                    %>
                            <div class="servicio">
                                <img src="${pageContext.request.contextPath}/img/<%= s.getImagen() != null && !s.getImagen().isEmpty() ? s.getImagen() : "default.jpg" %>" alt="<%= s.getNombre() %>" onerror="this.src='${pageContext.request.contextPath}/img/default.jpg'">
                                <h3><%= s.getNombre() %></h3>
                                <p><%= s.getDescripcion() %></p>
                                    ...
                                    <% } } else { %>
                                        <div class="servicio">
                                            ...
                                            <p>Estamos actualizando nuestro catálogo de servicios.</p>
                                        </div>
                                        <% } %>
                        </div>
...
===================== -->
                <section id="testimonios">
                    ...
                    <div class="testimonios-grid">
                        <% List<Comentario> comentariosAprobados = (List<Comentario>)
                                request.getAttribute("comentariosAprobados");
                                ...
                                for (int i = 0; i < maxComentarios; i++) { Comentario c=comentariosAprobados.get(i); %>
                                    <div class="testimonio">
                                        ...
                                        <p style="font-size:0.85rem;color:#888;">
                                            <%= c.getFechaCreacion() !=null ? new
                                                java.text.SimpleDateFormat("dd/MM/yyyy").format(c.getFechaCreacion())
                                                : "" %>
                                        </p>
                                    </div>
                                    <% } } else { %>
